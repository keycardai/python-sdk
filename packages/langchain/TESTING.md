...
| Owner stamped on thread creation, run creation and thread updates from the verified identity, unspoofable from the request body | covered | `test_thread_creation_stamps_the_owner`, `test_body_supplied_owner_cannot_be_forged`, `test_thread_update_stamps_the_owner` |
